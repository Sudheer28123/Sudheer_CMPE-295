...
int main(void)
{
    ...
    SystemInit();
		...
		xTaskCreate( MAGSEN_Task, ( signed char * ) "MAGSEN", configMINIMAL_STACK_SIZE+100, NULL, configADC_TASK_PRIORITY, NULL );
		xTaskCreate( ULTSEN_Task, ( signed char * ) "ULTSEN", configMINIMAL_STACK_SIZE, NULL, configULT_TASK_PRIORITY, NULL );
