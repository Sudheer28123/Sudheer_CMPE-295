...
int main(void)
{
	...
	/* Creating the MAGSEN_Task, which initializes the Magnetic Sensor module and then reads sensor data regularly. */
	xTaskCreate( MAGSEN_Task, ( signed char * ) "MAGSEN", configMINIMAL_STACK_SIZE, NULL, configADC_TASK_PRIORITY, NULL );
	...
	printf("\nCRITICAL ERROR!! Reached Enf of Main.");
	for( ;; );
}
/*-----------------------------------------------------------*/
